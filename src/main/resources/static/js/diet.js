...
$(function () {
    ...
    $('.dietUpdate').on('click', dietUpdate);
            ...
            success: function (result) {
                ...
                $('.btnAdd').on("click", function (e) {
                    ...
                    var data = {
                        ...
                        diet_kcal: $(this).siblings("td.diet_kcal").text() || 0,
                        diet_carbo: $(this).siblings("td.diet_carbo").text() || 0,
                        diet_protein: $(this).siblings("td.diet_protein").text() || 0,
                        diet_fat: $(this).siblings("td.diet_fat").text() || 0,
